...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("betacoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Betacoin application found.\nPlease install Betacoin Wallet.", Toast.LENGTH_LONG).show();
